...
namespace WebApiejemplo.Controllers
{
    ...
    public class MantenimientosController : ControllerBase
    {
        ...
        public MantenimientosController(IMantenimientoService service)
        {
            _service = service;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<Mantenimiento>> Create(Mantenimiento entity)
        {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Mantenimiento>> Update(int id, Mantenimiento entity)
        {
